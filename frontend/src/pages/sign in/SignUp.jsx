  ...
  <form onSubmit={handleSignUp} encType='multipart/form-data'>
            <div className="my-2 mx-auto border-[2px]  justify-center flex items-center rounded-md shadow-md">
                ...
                <div className="w-full">
                    <input type='text' x-model="input1" className="w-full h-12 px-4 py-1 rounded-r-md border border-gray-100 text-gray-800 focus:outline-none" placeholder="Name" name='name'/>
                </div>
            </div>
            ...
            <div className="my-2  mx-auto border-[2px]  justify-center flex items-center rounded-md shadow-md">
                ...
                <div className="w-full">
                    <input type='text' x-model="input3" className="w-full h-12 px-4 py-1 rounded-r-md border border-gray-100 text-gray-800 focus:outline-none" placeholder="Email" name='email'/>
                </div>
            </div>
            <div className="my-2  mx-auto border-[2px]  justify-center flex items-center rounded-md shadow-md">
                <div>
                ...
                <div className="w-full">
                    <input type='text' x-model="input2" className="w-full h-12 px-4 py-1 rounded-r-md border border-gray-100 text-gray-800 focus:outline-none" placeholder="Phone" name="phone" />
                </div>
            </div>
            <div className="my-2  mx-auto border-[2px]  justify-center flex items-center rounded-md shadow-md">
                <div>
                ...
                <div className="w-full">
                    <input type='text' x-model="input2" className="w-full h-12 px-4 py-1 rounded-r-md border border-gray-100 text-gray-800 focus:outline-none" placeholder="Collge" name="college" />
                </div>
            </div>
            <div className="my-2  mx-auto border-[2px]  justify-center flex items-center rounded-md shadow-md">
                <div>
...
<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M200-80q-33 0-56.5-23.5T120-160v-560q0-33 23.5-56.5T200-800h40v-80h80v80h320v-80h80v80h40q33 0 56.5 23.5T840-720v560q0 33-23.5 56.5T760-80H200Zm0-80h560v-400H200v400Zm0-480h560v-80H200v80Zm0 0v-80 80Zm280 240q-17 0-28.5-11.5T440-440q0-17 11.5-28.5T480-480q17 0 28.5 11.5T520-440q0 17-11.5 28.5T480-400Zm-160 0q-17 0-28.5-11.5T280-440q0-17 11.5-28.5T320-480q17 0 28.5 11.5T360-440q0 17-11.5 28.5T320-400Zm320 0q-17 0-28.5-11.5T600-440q0-17 11.5-28.5T640-480q17 0 28.5 11.5T680-440q0 17-11.5 28.5T640-400ZM480-240q-17 0-28.5-11.5T440-280q0-17 11.5-28.5T480-320q17 0 28.5 11.5T520-280q0 17-11.5 28.5T480-240Zm-160 0q-17 0-28.5-11.5T280-280q0-17 11.5-28.5T320-320q17 0 28.5 11.5T360-280q0 17-11.5 28.5T320-240Zm320 0q-17 0-28.5-11.5T600-280q0-17 11.5-28.5T640-320q17 0 28.5 11.5T680-280q0 17-11.5 28.5T640-240Z"/></svg>
                ...
                <div className="w-full">
                    <input type='text' x-model="input2" className="w-full h-12 px-4 py-1 rounded-r-md border border-gray-100 text-gray-800 focus:outline-none" placeholder="Year of Study/Passout Year" name="yearOfStudy" />
                </div>
            </div>
            <div className="my-2  mx-auto border-[2px]  justify-center flex items-center rounded-md shadow-md">
                <div>
                ...
                <div className="w-full">
                    <input type='text' x-model="input2" className="w-full h-12 px-4 py-1 rounded-r-md border border-gray-100 text-gray-800 focus:outline-none" placeholder="Branch/Stream" name="stream" />
                </div>
            </div>
            <div className="my-2  mx-auto border-[2px]  justify-center flex items-center rounded-md shadow-md">
                <div>
                ...
                <div className="w-full">
                    <input type='text' x-model="input2" className="w-full h-12 px-4 py-1 rounded-r-md border border-gray-100 text-gray-800 focus:outline-none" placeholder="Achievements" name="achievements" />
                </div>
            </div>
            <div className="my-2  mx-auto border-[2px]  justify-center flex items-center rounded-md shadow-md">
                <div>
                ...
                <div className="w-full">
                    <input type='text' x-model="input2" className="w-full h-12 px-4 py-1 rounded-r-md border border-gray-100 text-gray-800 focus:outline-none" placeholder="Goals" name='goals'/>
                </div>
            </div>
            <div className="my-2  mx-auto border-[2px]  justify-center flex items-center rounded-md shadow-md">
                <div>
                ...
                <div className="w-full">
                    <input type='text' x-model="input2" className="w-full h-12 px-4 py-1 rounded-r-md border border-gray-100 text-gray-800 focus:outline-none" placeholder="Interests" name="interests" />
                </div>
            </div>
            <div className="my-2  mx-auto border-[2px]  justify-center flex items-center rounded-md shadow-md">
                <div>
                ...
                <div className="w-full">
                    <input type='text' x-model="input2" className="w-full h-12 px-4 py-1 rounded-r-md border border-gray-100 text-gray-800 focus:outline-none" placeholder="I'm very good at" name='skills'/>
                </div>
            </div>
            <div className="my-2  mx-auto border-[2px]  justify-center flex items-center rounded-md shadow-md">
                <div>
...
<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M240-80q-33 0-56.5-23.5T160-160v-400q0-33 23.5-56.5T240-640h40v-80q0-83 58.5-141.5T480-920q83 0 141.5 58.5T680-720v80h40q33 0 56.5 23.5T800-560v400q0 33-23.5 56.5T720-80H240Zm0-80h480v-400H240v400Zm240-120q33 0 56.5-23.5T560-360q0-33-23.5-56.5T480-440q-33 0-56.5 23.5T400-360q0 33 23.5 56.5T480-280ZM360-640h240v-80q0-50-35-85t-85-35q-50 0-85 35t-35 85v80ZM240-160v-400 400Z"/></svg>
                ...
                <div className="w-full">
                    <input type="password" x-model="input2" className="w-full h-12 px-4 py-1 rounded-r-md border border-gray-100 text-gray-800 focus:outline-none" placeholder="Password" name="password" />
                </div>
            </div>
            <div className="my-2  mx-auto border-[2px]  justify-center flex items-center rounded-md shadow-md">
                <div>
